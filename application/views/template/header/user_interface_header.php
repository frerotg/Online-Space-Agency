...
<ul>
     ...
     <li><?= anchor('c_mission/index', 'Mission de l\'agence', array('title' => 'Accedez à la page de gestion des technologies')); ?></li>
     <li><?= anchor('c_equipment/index', 'Equipement de l\'agence', array('title' => 'Accedez à la page de gestion des equipements')); ?></li>
</ul>